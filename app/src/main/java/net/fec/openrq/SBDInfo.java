...
public final class SBDInfo {
        ...
        Set<Integer> availableRepairSymbols)
    {
        ...
        if (missingSourceSymbols == null)
   		 throw new NullPointerException();
        
        this.missingSourceSymbols = missingSourceSymbols;
        
        if (availableRepairSymbols == null)
   		 throw new NullPointerException();
        
        this.availableRepairSymbols = availableRepairSymbols;
    }
